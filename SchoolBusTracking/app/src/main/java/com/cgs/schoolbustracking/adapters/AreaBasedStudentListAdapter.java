...
public class AreaBasedStudentListAdapter extends RecyclerView.Adapter<AreaBasedStudentListAdapter.ViewHolder> implements Filterable {
    ...
    public AreaBasedStudentListAdapter(List<StudentDetailModel> studentsList, Context mContext, String busStop,ArrayList<String> list) {
        ...
        this.studentsList = db_student.getArrayStudentsListOfParticularBusStop(item.getBusStopName(), list);*/
...
//        int id = mContext.getResources().getIdentifier("com.cgs.schoolbustracking:drawable/" + studentsList.get(position).getName(), null, null);
//        if (id != -1) {
        holder.imgStudent.setImageDrawable(image);
//        } else {
//            holder.imgStudent.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.img_user));
//        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (studentsList != null) {
                ...
                studentsList = db_student.getArrayStudentsListOfParticularBusStop(busStop,list);

                notifyDataSetChanged();
            }


            if (mContext instanceof AreaBasedStudentListActivity) {
                ((AreaBasedStudentListActivity) mContext).getCount(db_student.getStudentsListWhereTrue().size(), db_student.getStudentsListWhereTrueOnBusstop(busStop).size());
            }
